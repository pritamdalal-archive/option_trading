...
dt_analysis <- as.Date("2019-03-14") # this was an error for march expirations
dt_expiration <- as.Date("2019-03-22") #backtestr::monthly_expiration(2019, 03)
...
write_csv(df_trade_sheet, "trade_sheet_20190314_weekly.csv")
print("DONE!")
toc()
